...
#BOTAO JOGAR
lista_botoes_jogar = [pygame.image.load("imagens" + os.sep + "jogar" + str(indice + 1) + ".png").convert() for indice in range(3)]
...
#BOTAO INSTRUCOES
lista_botoes_instrucoes = [pygame.image.load("imagens" + os.sep + "instrucoes" + str(indice + 1) + ".png").convert() for indice in range(3)]
...
#BOTAO OPCOES
lista_botoes_opcoes = [pygame.image.load("imagens" + os.sep + "opcoes" + str(indice + 1) + ".png").convert() for indice in range(3)]
...
#BOTAO CREDITOS
lista_botoes_creditos = [pygame.image.load("imagens" + os.sep + "creditos" + str(indice + 1) + ".png").convert() for indice in range(3)]
...
#BOTAO SAIR
lista_botoes_sair = [pygame.image.load("imagens" + os.sep + "sair" + str(indice + 1) + ".png").convert() for indice in range(3)]
