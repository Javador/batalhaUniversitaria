...
def main():
    ...
    #BOTAO JANELA
    lista_botoes_janela = [pygame.image.load("imagens" + os.sep + "janela" + str(indice + 1) + ".png").convert() for indice in range(3)]
    ...
    #BOTAO TELA CHEIA
    lista_botoes_tela_cheia = [pygame.image.load("imagens" + os.sep + "tela_cheia" + str(indice + 1) + ".png").convert() for indice in range(3)]
